            ...
            <div class="mobile-api-config-form">
                ...
                <details style="margin-bottom: 15px;">
                    ...
                    <div style="margin-left: 15px;">
                        ...
                        <!-- 系统提示词 -->
                        <div style="margin-bottom: 10px;">
                            <label style="display: block; margin-bottom: 5px; color: #000;">系统提示词:</label>
                            <textarea id="api-system-prompt" rows="3"
                                      placeholder="可选的系统提示词..."
                                      style="width: 100% !important; padding: 8px !important; border: 1px solid #ccc !important; border-radius: 4px !important; resize: vertical !important; box-sizing: border-box !important; background-color: #ffffff !important; color: #000000 !important; -webkit-user-select: text !important; user-select: text !important; min-height: 80px !important; height: 80px !important; font-size: 14px !important; display: block !important; visibility: visible !important; opacity: 1 !important; position: relative !important; z-index: 10002 !important;">${settings.systemPrompt}</textarea>
                        </div>
                    </div>
                </details>
                                    ...
                                    <div style="margin-top: 8px; margin-left: 10px;">
                                        ...
                                        <div style="margin-bottom: 6px;">
                                            ...
                                            <textarea id="profile-${key}-system-prompt" rows="2"
                                                      ...
                                                      style="width: 100% !important; padding: 6px !important; border: 1px solid #ccc !important; border-radius: 4px !important; font-size: 13px !important; resize: vertical !important; box-sizing: border-box !important; background-color: #ffffff !important; color: #000000 !important; -webkit-user-select: text !important; user-select: text !important; min-height: 50px !important; height: 50px !important; display: block !important; visibility: visible !important; opacity: 1 !important; position: relative !important; z-index: 10002 !important;">${profile.systemPrompt || ''}</textarea>
                                        </div>
                                    </div>
                                </details>
                            `;
